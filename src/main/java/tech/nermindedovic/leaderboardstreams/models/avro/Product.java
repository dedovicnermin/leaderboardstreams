...
public class Product extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -417398697976880530L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Product\",\"namespace\":\"tech.nermindedovic.leaderboardstreams.models.avro\",\"fields\":[{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"name\",\"type\":\"string\"}]}");
   ...
   */
  public Product(java.lang.Long id, java.lang.CharSequence name) {
    this.id = id;
    this.name = name;
  }
   ...
   */
  public static tech.nermindedovic.leaderboardstreams.models.avro.Product.Builder newBuilder() {
    return new tech.nermindedovic.leaderboardstreams.models.avro.Product.Builder();
  }
   ...
   * @return A new Product RecordBuilder
   */
  public static tech.nermindedovic.leaderboardstreams.models.avro.Product.Builder newBuilder(tech.nermindedovic.leaderboardstreams.models.avro.Product.Builder other) {
    if (other == null) {
      return new tech.nermindedovic.leaderboardstreams.models.avro.Product.Builder();
    } else {
      return new tech.nermindedovic.leaderboardstreams.models.avro.Product.Builder(other);
    }
  }
   ...
   * @return A new Product RecordBuilder
   */
  public static tech.nermindedovic.leaderboardstreams.models.avro.Product.Builder newBuilder(tech.nermindedovic.leaderboardstreams.models.avro.Product other) {
    if (other == null) {
      return new tech.nermindedovic.leaderboardstreams.models.avro.Product.Builder();
    } else {
      return new tech.nermindedovic.leaderboardstreams.models.avro.Product.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Product>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(tech.nermindedovic.leaderboardstreams.models.avro.Product.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(tech.nermindedovic.leaderboardstreams.models.avro.Product other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public tech.nermindedovic.leaderboardstreams.models.avro.Product.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public tech.nermindedovic.leaderboardstreams.models.avro.Product.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public tech.nermindedovic.leaderboardstreams.models.avro.Product.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public tech.nermindedovic.leaderboardstreams.models.avro.Product.Builder clearName() {
      name = null;
