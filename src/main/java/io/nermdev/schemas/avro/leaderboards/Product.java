...
public class Product extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static io.nermdev.schemas.avro.leaderboards.Product.Builder newBuilder() {
    return new io.nermdev.schemas.avro.leaderboards.Product.Builder();
  }
   ...
   * @return A new Product RecordBuilder
   */
  public static io.nermdev.schemas.avro.leaderboards.Product.Builder newBuilder(io.nermdev.schemas.avro.leaderboards.Product.Builder other) {
    if (other == null) {
      return new io.nermdev.schemas.avro.leaderboards.Product.Builder();
    } else {
      return new io.nermdev.schemas.avro.leaderboards.Product.Builder(other);
    }
  }
   ...
   * @return A new Product RecordBuilder
   */
  public static io.nermdev.schemas.avro.leaderboards.Product.Builder newBuilder(io.nermdev.schemas.avro.leaderboards.Product other) {
    if (other == null) {
      return new io.nermdev.schemas.avro.leaderboards.Product.Builder();
    } else {
      return new io.nermdev.schemas.avro.leaderboards.Product.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Product>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.nermdev.schemas.avro.leaderboards.Product.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.nermdev.schemas.avro.leaderboards.Product other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.nermdev.schemas.avro.leaderboards.Product.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.nermdev.schemas.avro.leaderboards.Product.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.nermdev.schemas.avro.leaderboards.Product.Builder setName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.nermdev.schemas.avro.leaderboards.Product.Builder clearName() {
      name = null;
