...
public class Player extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public Player(java.lang.Long id, java.lang.String name) {
    this.id = id;
    this.name = name;
  }
   ...
   */
  public static io.nermdev.schemas.avro.leaderboards.Player.Builder newBuilder() {
    return new io.nermdev.schemas.avro.leaderboards.Player.Builder();
  }
   ...
   * @return A new Player RecordBuilder
   */
  public static io.nermdev.schemas.avro.leaderboards.Player.Builder newBuilder(io.nermdev.schemas.avro.leaderboards.Player.Builder other) {
    if (other == null) {
      return new io.nermdev.schemas.avro.leaderboards.Player.Builder();
    } else {
      return new io.nermdev.schemas.avro.leaderboards.Player.Builder(other);
    }
  }
   ...
   * @return A new Player RecordBuilder
   */
  public static io.nermdev.schemas.avro.leaderboards.Player.Builder newBuilder(io.nermdev.schemas.avro.leaderboards.Player other) {
    if (other == null) {
      return new io.nermdev.schemas.avro.leaderboards.Player.Builder();
    } else {
      return new io.nermdev.schemas.avro.leaderboards.Player.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Player>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.nermdev.schemas.avro.leaderboards.Player.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.nermdev.schemas.avro.leaderboards.Player other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.nermdev.schemas.avro.leaderboards.Player.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.nermdev.schemas.avro.leaderboards.Player.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.nermdev.schemas.avro.leaderboards.Player.Builder setName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.nermdev.schemas.avro.leaderboards.Player.Builder clearName() {
      name = null;
